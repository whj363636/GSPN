...
from distrifuser.models.distri_sdxl_unet_pp import DistriUNetPP
from distrifuser.models.naive_patch_sdxl import NaivePatchUNet
from distrifuser.utils import DistriConfig, PatchParallelismCommManager

from src.fusion import LinFusion, GSPNFusion
...
class DistriSDXLPipeline:
    ...
    def from_pretrained(distri_config: DistriConfig, **kwargs):
        ...
        if distri_config.parallelism == "patch":
            ...
            pipeline.unet = NaivePatchUNet(pipeline.unet, distri_config)
        else:
